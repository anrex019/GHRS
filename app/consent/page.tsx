...
const Consent = () => {
  ...
  const { document, loading, error } = useLegalDocument(documentType, locale);
  
  // Fallback keys for static content
              ...
              <>
                ...
                <div className="prose prose-lg max-w-none">
                  <div 
                    ...
                    dangerouslySetInnerHTML={{ __html: document?.content || t(contentKey) }}
                  />
                </div>
