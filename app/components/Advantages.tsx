...
const Advantages = () => {
  const { t } = useI18n();
  return (
    <section className="w-full px-2 md:px-8 md:mb-8 mb-6">
      ...
      <div className="grid md:grid-cols-2 h-full grid-cols-1 md:gap-5 gap-4 w-full">
        <div className="flex flex-col gap-4 md:gap-5 w-full min-w-full">
          <div className="bg-[rgba(249,247,254,1)] md:rounded-[15px] rounded-3xl md:p-5 p-4 w-full">
            ...
            <p className="font-['PT_Root_UI'] md:text-[18px] text-[14px] text-[rgba(132,111,160,1)]  tracking-[0%] leading-[120%] font-medium md:mt-[59px] mt-8">
          ...
          <div className="bg-[rgba(249,247,254,1)] md:rounded-[15px] rounded-3xl md:p-5 p-4">
            ...
            <p className="font-['PT_Root_UI'] md:text-[18px] text-[14px] text-[rgba(132,111,160,1)] tracking-[0%] leading-[120%] font-medium md:mt-[75px] mt-8">
          ...
          <div className="flex flex-col  md:flex-row gap-4 md:gap-5 ">
            <div className="bg-[rgba(249,247,254,1)] w-full md:rounded-[15px] rounded-3xl md:p-5 p-4 ">
              ...
              <p className="font-['PT_Root_UI'] md:text-[18px] text-[14px] text-[rgba(132,111,160,1)]  tracking-[0%] leading-[120%] font-medium md:mt-[26px] mt-[122px]">
            ...
            <div className="bg-[rgba(249,247,254,1)] md:rounded-[15px] rounded-3xl md:p-5 p-4">
              ...
              <p className="font-['PT_Root_UI'] md:text-[18px] text-[14px] text-[rgba(132,111,160,1)]  tracking-[0%] leading-[120%] font-medium md:mt-[96px] mt-[168px]">
        ...
        <div className="flex flex-col gap-4 md:gap-5 ">
          <div className="bg-[rgba(249,247,254,1)] md:rounded-[15px] rounded-3xl md:p-5 p-4">
            ...
            <p className="font-['PT_Root_UI'] md:text-[18px] text-[14px] text-[rgba(132,111,160,1)]  tracking-[0%] leading-[120%] font-medium  md:mt-[130px] mt-[117px]">
          ...
          <div className="flex flex-col  md:flex-row gap-4 md:gap-5 ">
            <div className="bg-[rgba(249,247,254,1)] flex flex-col justify-between md:rounded-[15px] rounded-3xl md:p-5 p-4">
              ...
              <p className="font-['PT_Root_UI'] md:text-[18px] text-[14px] text-[rgba(132,111,160,1)]  tracking-[0%] leading-[120%] font-medium md:mt[230px] mt-[71px]">
            ...
            <div className="bg-[rgba(249,247,254,1)] md:rounded-[15px] rounded-3xl md:p-5 p-4 ">
              ...
              <p className="font-['PT_Root_UI'] md:text-[18px] text-[14px] text-[rgba(132,111,160,1)]  tracking-[0%] leading-[120%] font-medium md:mt-[230px] mt-[105px]">
